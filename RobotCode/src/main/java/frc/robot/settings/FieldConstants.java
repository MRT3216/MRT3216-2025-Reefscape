...
public class FieldConstants {
    ...
    public static class Barge {
        ...
        public static final Transform2d cageOffset = new Transform2d(
                FIELD_OFFSETS.cageXOffset + FIELD_OFFSETS.cageFieldTooShortOffset, 0,
    ...
    public static final class FIELD_OFFSETS {
        ...
        public static double reefXOffsetInitial = 1.0;
        public static double reefYOffsetLeftCoral = Units.inchesToMeters(-7);
        public static double reefYOffsetRightCoral = -1 * reefYOffsetLeftCoral;
        ...
        public static double cageFieldTooShortOffset = -1;
        public static double cageXOffset = 0.05;
        public static double cageRotation = 270;
    }
    ...
    public static class CoralStation {
        ...
        public static final Transform2d coralStationOffsetPose = new Transform2d(FIELD_OFFSETS.coralStationXOffset, 0,
    ...
    public static class Reef {
        ...
        public static final Transform2d getReefOffsetPoseInitial(boolean leftCoral) {
            return new Transform2d(FIELD_OFFSETS.reefXOffsetInitial,
                    leftCoral ? FIELD_OFFSETS.reefYOffsetLeftCoral : FIELD_OFFSETS.reefYOffsetRightCoral,
                    Rotation2d.fromDegrees(180));
        }

        public static final Transform2d reefOffsetPoseCloseAdj = new Transform2d(FIELD_OFFSETS.reefXOffsetCloseAdj,
                0,
                Rotation2d.fromDegrees(0));
    }
